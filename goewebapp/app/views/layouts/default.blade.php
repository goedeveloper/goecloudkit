  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li><a href={{ URL::to('myaccount') }}><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
          ...
          <li>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                ...
                <li><a href={{ URL::to('myaccount/accountsetting') }}><i class="glyphicon glyphicon-cog"></i> Account Settings</a></li>
