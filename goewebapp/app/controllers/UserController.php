...
class UserController extends BaseController {
	...
	public function getIndex()
	{
		...
		return View::make('admin.manage_user')->with('title','eden - Admin')
	...
	{
		return View::make('admin.add_user')->with('title','eden - Admin')->with("page_title","Add User");
	}
	...
	public function getEdituser($id){
		...
		return View::make('admin.edit_user')->with('title','eden - Admin')
		->with("page_title","Manage User")
		->with('user',$user);
	}
